...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # Does the block to each element consecutively with the inject value being
    # the first value done to the first element.
  end
  ...
  #     # code to read 'file'
    # Answer - We want iterate over each line
  #   end
  #
